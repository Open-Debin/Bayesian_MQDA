...
def main():
    ...
    args.save_dir = Path('../log/metadataset') / args.log_name
...
def load_config():
    ...
    parser.add_argument('-l_n','--log_name', help="The saved path of log.", required=True)
    ...
    args.strategy = 'map'
    args.title='lr{}_{}_reg{}_{}'.format(args.lr, args.optimizer, args.reg_param, args.strategy)
    return args
